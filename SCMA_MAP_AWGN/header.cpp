...
void Initialize(char* argv[]){
    ...
    cout<<"SCMA_ST_AWGN"<<endl;
    outfile.open("SCMA_ST_AWGN.txt", ios::out|ios::app);
    outfile<<"....................................................."<<endl;
    outfile<<"SCMA_ST_AWGN"<<endl;
...
void InitMapMatrix(MapMatrix& map, SubConstellMatrix& subConstell, 
    ...
    cout<<"Number of sources: "<<Nt*M<<setw(20)<<"NLoop: "<<NLoop<<endl;   
    outfile<<"Number of sources: "<<Nt*M<<setw(20)<<"NLoop: "<<NLoop<<endl; 
...
void Receiver(SymAfterBFMatrix* symafterbf, 
    ...
    for(int nj = 0; nj < Nj; nj++){
        for(int u = 0; u < U; u++){
            ...
            symAfterPP[nj][u] = symafterbf[nj] + tmp;
        }
    }
}
